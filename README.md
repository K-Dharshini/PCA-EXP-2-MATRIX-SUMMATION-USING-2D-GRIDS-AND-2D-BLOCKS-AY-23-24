...
i.  Use the file sumMatrixOnGPU-2D-grid-2D-block.cu <br>
...
## OUTPUT
<img width="1554" height="162" alt="image" src="https://github.com/user-attachments/assets/992ee9a6-a1b3-4acb-a1a5-13a606f6f601" />

## RESULT
The host took 1.103598 seconds to complete it’s computation, while the GPU outperforms the host and completes the computation in 0.045438 seconds. Therefore, float variables in the GPU will result in the best possible result. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
